<?php $data = BloGoBack\Back::CategoriasData(); $post = BloGoBack\Back::PublicacionaVer($_GET['id']); ?>
<script type="text/javascript">
	...
	function updatePost(stts){
	    ...
	    var ajaxUrl = '../../core/actions.php?UpdatePostBlog=<?php echo $_GET['id']; ?>';
	    $.ajax({
	      url : ajaxUrl,
	      type : "POST",
	      data : formData,
	      ...
	      processData : false
	    	...
	    	if (json.status == 1) { alert('Post Actualizado'); location.reload();}
					...
					<div class="row">
						<div class="col-md-4">
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $post['title']; ?>" aria-describedby="emailHelp">
							</div>
						</div>
						<div class="col-md-4">
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Keywords</label>
								<input type="text" class="form-control" name="keywords" value="<?php echo $post['keywords']; ?>" id="keywords" aria-describedby="emailHelp">
							</div>
						</div>
						<div class="col-md-4">
							<div class="mb-3">
						...
						<div class="col-md-8">
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="prologo" value="<?php echo $post['prologo']; ?>" id="prologo" aria-describedby="emailHelp">
							</div>
						</div>
						<div class="col-md-4">
						...
						<div class="col-md-12">
							<div class="mb-3">
								...
								<textarea id="contenido" name="contenido"><?php echo $post['content']; ?></textarea>
							</div>
						</div>
